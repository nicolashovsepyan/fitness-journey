...
/* THE MARK ALONE — no tile, transparent, cropped to the artwork.
   ...
   The box: the triangle occupies x 63..449 and y 100.5..435.5 once the
   icon layout's 1.42 scale is applied, and the neon bloom reaches about
   18px past the stroke. Hence 45,82 and 422x372 — hug the mark, keep the
   glow. If ICON_LAYOUT moves, this moves with it. */
export function markSVG() {
  const { tri, db } = ICON_LAYOUT;
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="45 82 422 372">
  <!-- GENERATED by tools/build-logo.mjs from logo/mark.mjs — do not edit. -->
  <defs>
${triGradient()}
${dbGradient()}
