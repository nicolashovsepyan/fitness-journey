/* ============================================================
   ...
   Takes the rendered artwork in the folder named by tools/paths.mjs,
   resizes it, and
...
import { ROOT, artwork, nicolas, must } from './paths.mjs';
...
writeFileSync(join(must(nicolas(), 'FOR NICOLAS'), 'IMAGES TO MAKE.md'), [
