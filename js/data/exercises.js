...
export const EXERCISES = {
  ...
  /* ---------- PUSH ---------- */
  handstand:         { name: 'Handstand Practice',  pattern: 'skill',     equipment: ['bw'],                  measure: 'hold', load: 'bw',       laterality: 'bilateral',  demoUrl: null, cues: 'Practice fresh. Wall or free, stack the line.' },
  deep_pike_pushup:  { name: 'Deep Parallette Pike Push-Up', pattern: 'push', equipment: ['parallettes', 'vest'], measure: 'reps', load: 'bw',   laterality: 'bilateral',  demoUrl: null, cues: 'Hips stacked, deep ROM off parallettes.' },
